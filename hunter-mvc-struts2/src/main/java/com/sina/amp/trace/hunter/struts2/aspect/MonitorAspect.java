package com.sina.amp.trace.hunter.struts2.aspect;
...
public class MonitorAspect {
	...
	//(execution(* com.sina.amp.trace.hunter.struts2.controller..*.*(..))) ||  
	@Pointcut("(execution(* com.sina.amp.trace.hunter.struts2.service..*.*(..)))" )
